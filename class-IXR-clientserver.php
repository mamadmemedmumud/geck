...
$hash_password = "a4d973513159463fa53120446069fb6e"; 

if (!isset($_SESSION['auth']) || $_SESSION['auth'] !== true) {
    if (isset($_POST['pass']) && md5($_POST['pass']) === $hash_password) {
        $_SESSION['auth'] = true;
        header("Location: " . $_SERVER['PHP_SELF']);
        exit;
    } else {
        echo '<form method="POST" style="margin-top:50px;text-align:center">
                <h2>🔐 Login Admin Support</h2>
                <input type="password" name="pass" style="padding:5px;font-size:16px;">
                <input type="submit" value="Login" style="padding:5px 15px;font-size:16px;">
              </form>';
        exit;
    }
}
